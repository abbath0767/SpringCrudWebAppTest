    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="formcontainer">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <button type="button" class="btn btn-default" ng-model="ctrl.user.admin" id="admin">Admin
                        </button>
                    </div>
                </div>
                    ...
                    <#--<div class="row">-->
                        <#--<div class="form-group col-md-12">-->
                            <#--<label class="col-md-2 control-lable" for="admin">is Admin </label>-->
                            <#--<div class="checkbox">-->
                                <#--<input type="checkbox" value="" ng-model="ctrl.user.admin" id="admin">-->
                            <#--</div>-->
                        <#--</div>-->
                    <#--</div>-->
