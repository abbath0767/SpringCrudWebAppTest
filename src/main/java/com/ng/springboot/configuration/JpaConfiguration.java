package com.ng.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ng.springboot.repositories",
...
public class JpaConfiguration {
    ...
    */
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.ng.springboot.model" });
